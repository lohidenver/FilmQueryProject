ppackage com.skilldistillery.filmquery.entities;
...
public class Film {
	...
	@Override
	public int hashCode() {
		return Objects.hash(actor, description, id, languageId, length, rating, releaseYear, rentalDuration, rentalRate,
